...
import rs.hsk.onlineshopping.exception.ProductNotFoundException;
...
public class PageController {
	...
	/*
	 * @RequestMapping(value = { "/contact" }) public ModelAndView contcact() {
	 * ModelAndView mv = new ModelAndView("page"); mv.addObject("title", "contact");
	 * mv.addObject("userClickContact", true); return mv; }
	 */

	/*
	 * @RequestMapping(value = { "/about" }) public ModelAndView about() {
	 * ModelAndView mv = new ModelAndView("page"); mv.addObject("title", "about");
